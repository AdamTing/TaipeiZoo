...
class PavilionDetailRecycleView @JvmOverloads constructor(
    ...
    override val viewModel: PavilionDetailRecycleViewVM = PavilionDetailRecycleViewVM()
    ...
    init {
        ...
        viewModel.pavilionDetailRvAdapter
...
//                    }
    ...
    fun setRvAdapter(pavilionDetailRecycleAdapter: PavilionDetailRecycleAdapter) {
        this.adapter = pavilionDetailRecycleAdapter
